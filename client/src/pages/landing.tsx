            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input type="text" className="w-full" value={firstName} onChange={e => setFirstName(e.target.value)} />
                </div>
                <div>
                  <Label className="block text-sm font-medium text-gray-700 mb-2">
                    Last Name
                  </Label>
                  <Input type="text" className="w-full" value={lastName} onChange={e => setLastName(e.target.value)} />
                </div>
              </div>
